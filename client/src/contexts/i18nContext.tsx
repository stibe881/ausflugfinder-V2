...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "trips.imagePreview": "Vorschau:",
    "trips.coverImage": "Titelbild",
    ...
    "trips.deleteConfirmTitle": "Ausflug löschen bestätigen",
    ...
    "trips.loginRequiredToUploadPhotos": "Du musst angemeldet sein, um Fotos hochzuladen.",
    ...
    "home.destinations": "Ausflüge entdecken",
    "home.destinationsDesc": "Entdecke spannende Orte und speichere deine Lieblingsziele",
    "home.friends": "Ausflüge mit Freunden erleben",
    "home.friendsDesc": "Verwalte deine Freunde und teile Ausflüge mit ihnen. So könnt ihr gemeinsam Abenteuer erleben.",
    ...
    "auth.errorRequired": "E-Mail und Passwort sind erforderlich",
    ...
    "auth.agbAccept": "Ich akzeptiere die",
    "auth.agb": "AGB",
    "auth.agbRequired": "Sie müssen die AGB akzeptieren.",
    "common.loading": "Lädt...",
    ...
    "forgotPassword.submitButton": "Link senden",
    "forgotPassword.successMessage": "Wenn ein Konto mit dieser E-Mail existiert, wurde ein Link zum Zurücksetzen des Passworts gesendet.",
    "forgotPassword.backToLogin": "Zurück zum Login",
    "resetPassword.title": "Passwort zurücksetzen",
    "resetPassword.description": "Geben Sie Ihr neues Passwort ein.",
    ...
    "resetPassword.submitButton": "Passwort ändern",
    "resetPassword.successMessage": "Ihr Passwort wurde erfolgreich zurückgesetzt. Sie können sich jetzt anmelden.",
    "resetPassword.invalidToken": "Ungültiger oder abgelaufener Token.",
    ...
    "explore.destDeleteConfirmTitle": "Destination löschen bestätigen",
    ...
    "tripDetail.deleteConfirmTitle": "Ausflug löschen bestätigen",
    "tripDetail.updateSuccess": "Ausflug erfolgreich aktualisiert!",
    ...
    "plannerDetail.tripAdded": "Ausflug hinzugefügt!",
    "plannerDetail.tripRemoved": "Ausflug entfernt!",
    "plannerDetail.itemAdded": "Artikel hinzugefügt!",
    "plannerDetail.itemUpdated": "Artikel aktualisiert!",
    "plannerDetail.itemUpdateError": "Fehler beim Aktualisieren des Artikels",
    "plannerDetail.itemRemoved": "Artikel gelöscht!",
    "plannerDetail.budgetAdded": "Budget-Eintrag hinzugefügt!",
    "plannerDetail.budgetRemoved": "Budget-Eintrag gelöscht!",
    "plannerDetail.costUpdated": "Kosten aktualisiert!",
    "plannerDetail.costUpdateError": "Fehler beim Aktualisieren der Kosten",
    "plannerDetail.taskAdded": "Aufgabe hinzugefügt!",
    "plannerDetail.taskRemoved": "Aufgabe gelöscht!",
    "plannerDetail.planUpdated": "Planung aktualisiert!",
    "plannerDetail.planDeleted": "Planung gelöscht!",
    "plannerDetail.planDeleteError": "Fehler beim Löschen der Planung",
    "plannerDetail.selectTripRequired": "Bitte wähle einen Ausflug aus",
    "plannerDetail.selectDate": "Bitte gib ein Datum für die Wettervorhersage an",
    "plannerDetail.tripTitleRequired": "Bitte gib einen Titel und einen Ort an",
    "plannerDetail.itemRequired": "Bitte gib einen Artikel ein",
    "plannerDetail.fieldsRequired": "Bitte fülle alle Pflichtfelder aus",
    "plannerDetail.costRequired": "Bitte gib die tatsächlichen Kosten ein",
    "plannerDetail.taskRequired": "Bitte gib einen Titel ein",
    "plannerDetail.iCalDownloaded": "iCal-Datei heruntergeladen!",
    "plannerDetail.pdfDownloaded": "PDF-Datei heruntergeladen!",
    "plannerDetail.pdfDownloadError": "Fehler beim Herunterladen der PDF",
    "budgetCategories.transport": "Transport",
    "budgetCategories.food": "Verpflegung",
    "budgetCategories.accommodation": "Unterkunft",
    "budgetCategories.entrance": "Eintritte",
    "budgetCategories.activities": "Aktivitäten",
    "budgetCategories.shopping": "Einkaufen",
    "budgetCategories.insurance": "Versicherung",
    "budgetCategories.other": "Sonstiges",
    "packingCategories.clothing": "Kleidung",
    "packingCategories.shoes": "Schuhe",
    "packingCategories.electronics": "Elektronik",
    "packingCategories.toiletries": "Toilettenartikel",
    "packingCategories.equipment": "Ausrüstung",
    "packingCategories.documents": "Dokumente",
    "packingCategories.other": "Sonstiges",
    ...
    "destinations.namePlaceholder": "z.B. Schwarzwald",
    "destinations.locationPlaceholder": "z.B. Baden-Württemberg, Deutschland",
    "destinations.descPlaceholder": "Was macht diesen Ort besonders?",
    "destinations.imageUrlPlaceholder": "https://...",
    "destinations.createSuccess": "Destination erfolgreich erstellt!",
    "destinations.createError": "Fehler beim Erstellen: ",
    "destinations.updateSuccess": "Destination erfolgreich aktualisiert!",
    "destinations.updateError": "Fehler beim Aktualisieren: ",
    "destinations.deleteSuccess": "Destination gelöscht!",
    "destinations.deleteError": "Fehler beim Löschen: ",
    ...
    "profile.deleteAccount": "Profil löschen",
    "profile.deleteAccountBtn": "Profil löschen",
    "profile.deleteAccountConfirm": "Möchtest du dein Profil wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden. Alle deine Daten werden dauerhaft gelöscht.",
    "profile.deleteAccountConfirmTitle": "Profil löschen bestätigen",
    "profile.deleteAccountSuccess": "Profil erfolgreich gelöscht",
    "profile.deleteAccountError": "Fehler beim Löschen des Profils",
    ...
    "friends.addFriendBtn": "Freund hinzufügen",
    ...
    "friends.emailRequired": "Bitte geben Sie eine E-Mail-Adresse ein",
    "friends.cancel": "Abbrechen",
    "friends.add": "Hinzufügen",
    "friends.adding": "Hinzufügen...",
    "friends.addSuccess": "Freund hinzugefügt!",
    "friends.addError": "Fehler beim Hinzufügen des Freundes",
    "friends.userNotFound": "Benutzer mit dieser E-Mail nicht gefunden.",
    "friends.deleteConfirm": "Möchtest du diesen Freund wirklich löschen?",
    "friends.deleteSuccess": "Freund gelöscht!",
    ...
    "friends.inviteEmail": "Über E-Mail einladen",
    "friends.inviteWhatsApp": "Über WhatsApp einladen",
    "friends.sharedTripsTitle": "Gemeinsame Ausflüge",
    "friends.noSharedTrips": "Noch keine gemeinsamen Ausflüge",
    "friends.sharedDestinationsTitle": "Gemeinsame Destinationen",
    "friends.noSharedDestinations": "Noch keine gemeinsamen Destinationen",
    "friends.selectFriend": "Wähle einen Freund aus, um Details zu sehen",
    "friends.emailSubject": "Komm zu Ausflugfinder!",
    "friends.emailBody": "Hallo! Ich möchte dich einladen, meine Ausflüge und Destinationen auf Ausflugfinder zu teilen. Besuche https://ausflugfinder.ch und erstelle dein Konto!",
    "friends.whatsappMessage": "Hallo! Schau dir Ausflugfinder an - eine tolle App zum Planen und Teilen von Ausflügen! https://ausflugfinder.ch",
    "friends.pendingRequests": "Ausstehende Freundschaftsanfragen",
    ...
    "friends.sentInvitations": "Gesendete Einladungen",
    "friends.remind": "Erinnern",
    "friends.delete": "Löschen",
    "friends.deleteInviteConfirm": "Möchtest du diese Einladung wirklich löschen?",
    "friends.invitationDeleted": "Einladung gelöscht!",
    "friends.reminderSent": "Erinnerung gesendet!",
    "friends.deleteConfirmTitle": "Freund löschen bestätigen",
    "friends.deleteInviteConfirmTitle": "Einladung löschen bestätigen",
    ...
    "gallery.uploadDragDrop": "Ziehen Sie Ihr Bild hierher oder ",
    "gallery.uploadClick": "klicken Sie zum Hochladen",
    "gallery.uploadMaxSize": "Max. 5MB, JPG, PNG, WebP",
    "gallery.uploading": "Wird hochgeladen...",
    "gallery.uploadPhoto": "Foto hochladen",
    "gallery.imageCaption": "Fototitel (optional)",
    ...
    "weather.7dayForecast": "7-Tages-Vorhersage",
    "weather.today": "Heute",
    ...
    "weather.thunderstormWithHail": "Gewitter mit Hagel",
    "install.button": "Installieren",
    "install.buttonTitle": "App auf diesem Gerät installieren",
    "install.dialogTitle": "App installieren",
    "install.dialogDescription": "Installiere AusflugFinder auf deinem Gerät für schnellere und einfachere Nutzung",
    "install.benefitsTitle": "Mit der installierten App kannst du:",
    "install.benefit1": "Offline arbeiten und deine Trips verwalten",
    "install.benefit2": "Schneller auf die App zugreifen",
    "install.benefit3": "Auf dem Homescreen ein Symbol haben",
    "install.laterButton": "Später",
  },
  en: {
    ...
    "trips.deleteConfirmTitle": "Confirm Trip Deletion",
    ...
    "home.friends": "Experience Trips with Friends",
    ...
    "explore.destDeleteConfirmTitle": "Confirm Destination Deletion",
    ...
    "tripDetail.deleteConfirmTitle": "Confirm Trip Deletion",
    "tripDetail.updateSuccess": "Trip updated successfully!",
    "tripDetail.updateError": "Error updating trip.",
    "tripDetail.deleteSuccess": "Trip deleted successfully!",
    "tripDetail.deleteError": "Error deleting trip.",
    ...
    "plannerDetail.tripAdded": "Trip added!",
    "plannerDetail.tripRemoved": "Trip removed!",
    "plannerDetail.itemAdded": "Item added!",
    "plannerDetail.itemUpdated": "Item updated!",
    "plannerDetail.itemUpdateError": "Error updating item",
    "plannerDetail.itemRemoved": "Item deleted!",
    "plannerDetail.budgetAdded": "Budget entry added!",
    "plannerDetail.budgetRemoved": "Budget entry deleted!",
    "plannerDetail.costUpdated": "Cost updated!",
    "plannerDetail.costUpdateError": "Error updating cost",
    "plannerDetail.taskAdded": "Task added!",
    "plannerDetail.taskRemoved": "Task deleted!",
    "plannerDetail.planUpdated": "Plan updated!",
    "plannerDetail.planDeleted": "Plan deleted!",
    "plannerDetail.planDeleteError": "Error deleting plan",
    "plannerDetail.selectTripRequired": "Please select a trip",
    "plannerDetail.selectDate": "Please provide a date for weather forecast",
    "plannerDetail.tripTitleRequired": "Please provide a title and location",
    "plannerDetail.itemRequired": "Please provide an item",
    "plannerDetail.fieldsRequired": "Please fill all required fields",
    "plannerDetail.costRequired": "Please provide the actual cost",
    "plannerDetail.taskRequired": "Please provide a title",
    "plannerDetail.iCalDownloaded": "iCal file downloaded!",
    "plannerDetail.pdfDownloaded": "PDF file downloaded!",
    "plannerDetail.pdfDownloadError": "Error downloading PDF",
    "budgetCategories.transport": "Transport",
    "budgetCategories.food": "Food & Dining",
    "budgetCategories.accommodation": "Accommodation",
    "budgetCategories.entrance": "Entrance Fees",
    "budgetCategories.activities": "Activities",
    "budgetCategories.shopping": "Shopping",
    "budgetCategories.insurance": "Insurance",
    "budgetCategories.other": "Other",
    "packingCategories.clothing": "Clothing",
    "packingCategories.shoes": "Shoes",
    "packingCategories.electronics": "Electronics",
    "packingCategories.toiletries": "Toiletries",
    "packingCategories.equipment": "Equipment",
    "packingCategories.documents": "Documents",
    "packingCategories.other": "Other",
    ...
    "destinations.namePlaceholder": "e.g. Black Forest",
    "destinations.locationPlaceholder": "e.g. Baden-Württemberg, Germany",
    "destinations.descPlaceholder": "What makes this place special?",
    "destinations.imageUrlPlaceholder": "https://...",
    "destinations.createSuccess": "Destination created successfully!",
    "destinations.createError": "Error creating: ",
    "destinations.updateSuccess": "Destination updated successfully!",
    "destinations.updateError": "Error updating: ",
    "destinations.deleteSuccess": "Destination deleted!",
    "destinations.deleteError": "Error deleting: ",
    ...
    "friends.emailRequired": "Please enter an email address",
    "friends.cancel": "Cancel",
    "friends.add": "Add",
    "friends.adding": "Adding...",
    "friends.addSuccess": "Friend added!",
    "friends.addError": "Error adding friend",
    "friends.userNotFound": "User with this email not found.",
    "friends.deleteConfirm": "Are you sure you want to delete this friend?",
    "friends.deleteSuccess": "Friend deleted!",
    ...
    "friends.inviteEmail": "Invite via Email",
    "friends.inviteWhatsApp": "Invite via WhatsApp",
    "friends.sharedTripsTitle": "Shared Trips",
    "friends.noSharedTrips": "No shared trips yet",
    "friends.sharedDestinationsTitle": "Shared Destinations",
    "friends.noSharedDestinations": "No shared destinations yet",
    "friends.selectFriend": "Select a friend to see details",
    "friends.emailSubject": "Join Ausflugfinder!",
    "friends.emailBody": "Hi! I'd like to invite you to share my trips and destinations on Ausflugfinder. Visit https://ausflugfinder.ch and create your account!",
    "friends.whatsappMessage": "Check out Ausflugfinder - a great app for planning and sharing trips! https://ausflugfinder.ch",
    ...
    "friends.sentInvitations": "Sent Invitations",
    "friends.remind": "Remind",
    "friends.delete": "Delete",
    "friends.deleteInviteConfirm": "Are you sure you want to delete this invitation?",
    "friends.invitationDeleted": "Invitation deleted!",
    "friends.reminderSent": "Reminder sent!",
    "friends.deleteConfirmTitle": "Confirm Friend Deletion",
    "friends.deleteInviteConfirmTitle": "Confirm Invitation Deletion",
  ...
  fr: {
    ...
    "trips.deleteConfirmTitle": "Confirmer la suppression du voyage",
    ...
    "home.friends": "Vivre des Voyages avec des Amis",
    ...
    "auth.errorRequired": "L'e-mail et le mot de passe sont obligatoires",
    ...
    "destinations.imageUrlPlaceholder": "https://...",
    "destinations.createSuccess": "Destination créée avec succès!",
    "destinations.createError": "Erreur lors de la création: ",
    "destinations.updateSuccess": "Destination mise à jour avec succès!",
    "destinations.updateError": "Erreur lors de la mise à jour: ",
    ...
    "admin.back": "Retour",
    "admin.pageTitle": "Portail Admin",
    "admin.adminBadge": "Admin",
    "admin.dashboard": "Tableau de Bord",
    "admin.totalTrips": "Total Voyages",
    "admin.allTrips": "Tous les voyages enregistrés",
    "admin.categoriesCount": "Catégories",
    "admin.availableCategories": "Catégories disponibles",
    "admin.freeActivities": "Gratuit",
    "admin.freeCount": "Activités gratuites",
    "admin.userAccount": "Compte Utilisateur",
    "admin.adminUser": "Utilisateur Admin",
    "admin.tripsManagement": "Gestion des Voyages",
    "admin.favorite": "Favori",
    "admin.public": "Public",
    "admin.view": "Afficher",
    "admin.destination": "Destination:",
    ...
    "admin.region": "Région:",
    "admin.cost": "Coût:",
    "admin.costFree": "Gratuit",
    "admin.noTrips": "Aucun voyage trouvé",
    "tripDetail.deleteConfirmTitle": "Confirmer la suppression du voyage",
    "plannerDetail.deleteConfirmTitle": "Confirmer la suppression du plan",
    "friends.deleteConfirmTitle": "Confirmer la suppression de l'ami",
    "friends.deleteInviteConfirmTitle": "Confirmer la suppression de l'invitation",
  },
  it: {
    ...
    "trips.deleteConfirmTitle": "Conferma eliminazione viaggio",
    ...
    "home.friends": "Vivi Avventure con gli Amici",
    ...
    "auth.errorRequired": "Email e password sono obbligatori",
    ...
    "destinations.namePlaceholder": "ad esempio Foresta Nera",
    "destinations.locationPlaceholder": "ad esempio Baden-Württemberg, Germania",
    "destinations.descPlaceholder": "Cosa rende questo posto speciale?",
    "destinations.imageUrlPlaceholder": "https://...",
    "destinations.createSuccess": "Destinazione creata con successo!",
    "destinations.createError": "Errore durante la creazione: ",
    "destinations.updateSuccess": "Destinazione aggiornata con successo!",
    "destinations.updateError": "Errore durante l'aggiornamento: ",
    "destinations.deleteSuccess": "Destinazione eliminata!",
    "destinations.deleteError": "Errore durante l'eliminazione: ",
    "explore.destDeleteConfirm": "Vuoi veramente eliminare questa destinazione?",
    "explore.destDeleteConfirmTitle": "Conferma eliminazione destinazione",
    "admin.accessDenied": "Accesso Negato",
    "admin.noPermission": "Non hai i permessi di amministratore",
    "admin.backHome": "Torna alla home",
    "admin.back": "Indietro",
    "admin.pageTitle": "Portale Admin",
    "admin.adminBadge": "Admin",
    "admin.dashboard": "Pannello di Controllo",
    "admin.totalTrips": "Viaggi Totali",
    "admin.allTrips": "Tutti i viaggi registrati",
    "admin.categoriesCount": "Categorie",
    "admin.availableCategories": "Categorie disponibili",
    "admin.freeActivities": "Gratis",
    "admin.freeCount": "Attività gratuite",
    "admin.userAccount": "Account Utente",
    "admin.adminUser": "Utente Admin",
    "admin.tripsManagement": "Gestione Viaggi",
    "admin.favorite": "Preferito",
    "admin.public": "Pubblico",
    "admin.view": "Visualizza",
    "admin.destination": "Destinazione:",
    "admin.category": "Categoria:",
    "admin.region": "Regione:",
    "admin.cost": "Costo:",
    "admin.costFree": "Gratis",
    "admin.noTrips": "Nessun viaggio trovato",
    "tripDetail.deleteConfirmTitle": "Conferma eliminazione viaggio",
    "plannerDetail.deleteConfirmTitle": "Conferma eliminazione del piano",
    "friends.userNotFound": "Utente con questa e-mail non trovato.",
    "friends.addError": "Errore durante l'aggiunta dell'amico",
    "friends.deleteConfirmTitle": "Conferma eliminazione amico",
    "friends.deleteInviteConfirmTitle": "Conferma eliminazione invito",
  },
};
